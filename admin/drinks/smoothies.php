...
<body>
	...
	<div class="sidebar">
		<ul class="sidebar-nav">
			...
			<li  class="sidebar-nav-item">
				<a href="./hot.php" class="sidebar-nav-link ">
					<div>
            ...
            <li  class="sidebar-nav-item">
				<a href="./smoothies.php" class="sidebar-nav-link active">
					<div>
					<i class="fas fa-wine-glass" ></i>
					</div>
	...
	<div class="wrapper">
    <div class="conta">
       <button class="btn1 btn-success"><a href="./smoothy/add-smoothy/add.php" class="text-light">Add Smoothy Drinks</a></button>
                        ...
                        while($row = mysqli_fetch_assoc($result)){
							...
							echo '
                                <tr>
                                    <td>'.$id.'</td>    
                                    <td scope="row">
                                        <img src="./smoothy/add-smoothy/uploads/'.$image.'" width="50px" height="50px" >
                                    </td>
                                    <td>'.$name.'</td>
                                    <td>'.$price.'</td>
									<td>'.$quantity.'</td>
									...
									<td>'.$product_code.'</td>
                                    <td>
                                        <a href="./cruds/smoothy/update.php?id='.$id.'" class="btn btn-primary">Update</a>
                                        <a href="./cruds/smoothy/delete.php?id='.$id.'" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>';
