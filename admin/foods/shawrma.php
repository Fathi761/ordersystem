...
<body>
	...
	<div class="sidebar">
		<ul class="sidebar-nav">
            ...
            <li  class="sidebar-nav-item">
				<a href="./shawrma.php" class="sidebar-nav-link active">
					<div>
					<i class="fas fa-utensils" ></i>
					</div>
					<span>Shawrma</span>
	...
	<div class="wrapper">
    <div class="conta">
       <button class="btn1 btn-success"><a href="./shawrma/add-shawrma/add.php" class="text-light">Add Shawrma</a></button>
					...
					while($row = mysqli_fetch_assoc($result)){
						...
						echo '
							<tr>
								<td>'.$id.'</td>    
								<td scope="row">
									<img src="./shawrma/add-shawrma/uploads/'.$image.'" width="50px" height="50px" >
								</td>
								<td>'.$name.'</td>
								<td>'.$price.'</td>
								<td>'.$quantity.'</td>
									...
									<td>'.$product_code.'</td>
								<td>
									<a href="./cruds/shawrma/update.php?id='.$id.'" class="btn btn-primary">Update</a>
									<a href="./cruds/shawrma/delete.php?id='.$id.'" class="btn btn-danger">Delete</a>
								</td>
							</tr>';
