...
<body>
	...
	<div class="sidebar">
		<ul class="sidebar-nav">
            ...
            <li  class="sidebar-nav-item">
				<a href="./sandwich.php" class="sidebar-nav-link active">
					<div>
					<i class="fas fa-utensils" ></i>
					</div>
					<span>Sandwich</span>
	...
	<div class="wrapper">
    <div class="conta">
       <button class="btn1 btn-success"><a href="./sandwich/add-sandwich/add.php" class="text-light">Add Sandwich</a></button>
					...
					while($row = mysqli_fetch_assoc($result)){
						...
						echo '
							<tr>
								<td>'.$id.'</td>    
								<td scope="row">
									<img src="./sandwich/add-sandwich/uploads/'.$image.'" width="50px" height="50px" >
								</td>
								<td>'.$name.'</td>
								<td>'.$price.'</td>
								<td>'.$quantity.'</td>
									...
									<td>'.$product_code.'</td>
								<td>
									<a href="./cruds/sandwich/update.php?id='.$id.'" class="btn btn-primary">Update</a>
									<a href="./cruds/sandwich/delete.php?id='.$id.'" class="btn btn-danger">Delete</a>
								</td>
							</tr>';
