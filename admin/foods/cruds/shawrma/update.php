...
if(isset($_GET['id'])){
    ...
    $sql = "SELECT * FROM `shawrma` WHERE id= $ID";
...
<div class="main">
<a href="../../shawrma.php" class="btn btn-warning"><i class="fas fa-long-arrow-alt-left"></i> Back</a>

        <div class="container">
            <div class="user">
            <h3>Shawrma Management</h3>
                ...
                <form action="./up.php" method="post" class="form" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-25">
                            ...
                            <img src="<?php echo "../../shawrma/add-shawrma/uploads/".$data['image']; ?>" width="50px" height="50px">
                    ...
                    <div class="btn">
                        <a href="../../shawrma.php" class="btn btn-danger">Cancel</a>
