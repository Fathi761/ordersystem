...
<div class="main">
<a href="../../burger.php" class="btn btn-warning"><i class="fas fa-long-arrow-alt-left"></i> Back</a>
                ...
                <form action="./up.php" method="post" class="form" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-25">
                            ...
                            <img src="<?php echo "../../burger/add-burger/uploads/".$data['image']; ?>" width="50px" height="50px">
                    ...
                    <div class="btn">
                        <a href="../../burger.php" class="btn btn-danger">Cancel</a>
