...
if(isset($_GET['id'])){
    ...
    $sql = "SELECT * FROM `fries` WHERE id= $ID";
...
<div class="main">
<a href="../../fries.php" class="btn btn-warning"><i class="fas fa-long-arrow-alt-left"></i> Back</a>

        <div class="container">
            <div class="user">
            <h3>Fries Management</h3>
                ...
                <form action="./up.php" method="post" class="form" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-25">
                            ...
                            <img src="<?php echo "../../fries/add-fries/uploads/".$data['image']; ?>" width="50px" height="50px">
                    ...
                    <div class="btn">
                        <a href="../../fries.php" class="btn btn-danger">Cancel</a>
