...
<body>
	...
	<div class="sidebar">
		<ul class="sidebar-nav">
            ...
            <li  class="sidebar-nav-item">
				<a href="../foods/burger.php" class="sidebar-nav-link active">
					<div>
            ...
            <li  class="sidebar-nav-item">
				<a href="./fries.php" class="sidebar-nav-link">
					<div>
            ...
            <li  class="sidebar-nav-item">
				<a href="./salad.php" class="sidebar-nav-link">
					<div>
            ...
            <li  class="sidebar-nav-item">
				<a href="./sandwich.php" class="sidebar-nav-link">
					<div>
					<i class="fas fa-utensils" ></i>
					</div>
					<span>Sandwich</span>
            ...
            <li  class="sidebar-nav-item">
				<a href="./shawrma.php" class="sidebar-nav-link">
					<div>
					<i class="fas fa-utensils" ></i>
					</div>
					<span>Shawrma</span>
            ...
            <li  class="sidebar-nav-item">
				<a href="./falafel.php" class="sidebar-nav-link">
					<div>
					<i class="fas fa-utensils" ></i>
					</div>
					<span>Falafel</span>
	...
	<div class="wrapper">
    <div class="conta">
       <button class="btn1 btn-success"><a href="./burger/add-burger/add.php" class="text-light">Add Burger</a></button>
                        ...
                        while($row = mysqli_fetch_assoc($result)){
							...
							echo '
                                <tr>
                                    <td>'.$id.'</td>    
                                    <td scope="row">
                                        <img src="./burger/add-burger/uploads/'.$image.'" width="50px" height="50px" >
                                    </td>
                                    <td>'.$name.'</td>
                                    <td>'.$price.'</td>
                                    <td>'.$quantity.'</td>
									...
									<td>'.$product_code.'</td>
                                    <td>
                                        <a href="./cruds/burger/update.php?id='.$id.'" class="btn btn-primary">Update</a>
                                        <a href="./cruds/burger/delete.php?id='.$id.'" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>';
