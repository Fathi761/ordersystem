...
<body>
	...
	<div class="sidebar">
		<ul class="sidebar-nav">
            ...
            <li  class="sidebar-nav-item">
				<a href="./fries.php" class="sidebar-nav-link active">
					<div>
	...
	<div class="wrapper">
    <div class="conta">
       <button class="btn1 btn-success"><a href="./fries/add-fries/add.php" class="text-light">Add Fries</a></button>
                    ...
                    while($row = mysqli_fetch_assoc($result)){
						...
						echo '
							<tr>
								<td>'.$id.'</td>    
								<td scope="row">
									<img src="./fries/add-fries/uploads/'.$image.'" width="50px" height="50px" >
								</td>
								<td>'.$name.'</td>
								<td>'.$price.'</td>
								<td>'.$quantity.'</td>
								...
								<td>'.$product_code.'</td>
								<td>
									<a href="./cruds/fries/update.php?id='.$id.'" class="btn btn-primary">Update</a>
									<a href="./cruds/fries/delete.php?id='.$id.'" class="btn btn-danger">Delete</a>
								</td>
							</tr>';
