...
<body>
	...
	<div class="sidebar">
		<ul class="sidebar-nav">
			...
			<li class="sidebar-nav-item">
				<a href="booking.php" class="sidebar-nav-link active">
					<div>
	...
	<div class="wrapper">
    <div class="conta">
	<button class="btn1 btn-success"><a href="./cruds/add-booking/add.php" class="text-light">Add Reservation</a></button>
                    ...
                    while($row = mysqli_fetch_assoc($result)){
						...
						echo '
							<tr>
								...
								<td>
									<a href="./cruds/booking/update.php?id='.$id.'" class="btn btn-primary">Update</a>
									<a href="./cruds/booking/delete.php?id='.$id.'" class="btn btn-danger">Delete</a>
								</td>
							</tr>';
