...
<body>
	...
	<div class="wrapper">
    <div class="conta">
	<button class="btn1 btn-success"><a href="./cruds/add-user/add.php" class="text-light">Add User</a></button>
                    ...
                    while($row = mysqli_fetch_assoc($result)){
						...
						echo '
							<tr>
								<td>'.$id.'</td>    
								<td scope="row">
									<img src="../../login/login-system/uploads/'.$image.'" width="50px" height="50px" >
								</td>
								<td>'.$name.'</td>
								<td>'.$email.'</td>
								<td>'.$password.'</td>
								<td>'.$usertype.'</td>
								<td>
									<a href="./cruds/users/update.php?id='.$id.'" class="btn btn-primary">Update</a>
									<a href="./cruds/users/delete.php?id='.$id.'" class="btn btn-danger">Delete</a>
								</td>
							</tr>';
