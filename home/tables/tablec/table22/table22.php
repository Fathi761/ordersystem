              ...
              <table class="table  text-center">
                <thead>
                  ...
                  <tr>
                    ...
                    <th>Total Price</th>
                    <th>
                      <a href="./pay.php?clear=all" class="badge-danger badge p-1" ><i class="fas fa-trash"></i>&nbsp;&nbsp;Clear Cart</a>
                    </th>
                  </tr>
                </thead>
                <tbody>
                    ...
                    <form action="./check.php" method="post">
                        <tr>
                            <td colspan="2">
                                ...
                                <input type="hidden" name="table" id="input" class="form-control" value="table22">
