  ...
  <div class="container">
          ...
          <table class="table">
              ...
              <tr>
                  ...
                  <td><a href="delete.php?remove=<?= $row['id'] ?>" class="text-danger lead"><i class="fas fa-trash-alt"></i></a></td>
              </tr>
              </tbody>
              <?php 
          ...
          <div class="totalorders">
            <div class="left">
              ...
              <p>Total in USD: <span><?php echo number_format($sum); ?></span> $</p>
            </div>
            <div class="right">
              <?php
              ...
              <p>Total in L.L: <span> <?= number_format($row['amount_LL'],2); ?></span> L.L</p>
            </div>
          </div>
