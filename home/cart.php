  ...
  <nav class="navbar navbar-expand-md bg-dark navbar-dark">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link active" href="home.php"><i class="fas fa-mobile-alt mr-2"></i>Home</a>
        </li>
        <li class="nav-item">
          ...
          <table class="table table-bordered table-striped text-center">
            <thead>
              ...
              <tr>
                ...
                <th>Total Price</th>
                <th>
                  <a href="pay.php?clear=all" class="badge-danger badge p-1" onclick="return confirm('Are you sure want to clear your cart?');"><i class="fas fa-trash"></i>&nbsp;&nbsp;Clear Cart</a>
                </th>
              </tr>
            </thead>
            <tbody>
