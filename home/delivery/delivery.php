                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel" style="color: #000">Delivery Order</h5>
                        ...
                        <div class="modal-body">
                          <form action="./order.php" method="post">
                            <div class="form-group">
                              ...
                              <input type="text"  class="form-control" id="recipient-name" value="<?= number_format($grand_total,2); ?>" disabled>
                            </div>
                            <div class="form-group">
