...
<body>
  ...
  <nav class="navbar navbar-expand-md">
      <!-- Brand -->
      <a class="navbar-brand" href="index.php"><i class="fas fa-mobile-alt"></i>&nbsp;&nbsp;Technoplus</a>
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
        ...
        <li class="nav-item">
          ...
          <!-- <li class="nav-item">
            <a class="nav-link" href="home.php"><i class="fas fa-mobile-alt mr-2"></i>Box</a>
          </li> -->
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../login/login-system/logout.php"><i class="fas fa-sign-out-alt mr-2"></i>Log out</a>
          </li>
        </ul>
      </div>
    </nav>
              ...
              <table class="table  text-center">
                <thead>
                  ...
                  <tr>
                    ...
                    <th>Total Price</th>
                    <th>
                      <a href="pay.php?clear=all" class="badge-danger badge " onclick="return confirm('Are you sure want to clear your cart?');"><i class="fas fa-trash"></i>&nbsp;&nbsp;Clear Cart</a>
                    </th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="pay.php?remove=<?= $row['id'] ?>" class="text-danger lead" onclick="return confirm('Are you sure want to remove this item?');"><i class="fas fa-trash-alt"></i></a>
                    </td>
                  </tr>
                  <?php 
        ...
        <h1 class="heading"> <span> Table Reservation </span> </h1>
          ...
          <form action="./booking.php" method="post">
            ...
            <div class="inputBox">
                ...
                <input type="number" placeholder="How many members..?" name="members">
            </div>
            <div class="inputBox">
            ...
            <div class="inputBox">
              <textarea cols="100" rows="10" placeholder="Information about this reservation." name="information"></textarea>
            </div>
        
            
        
            <input type="submit" value="Book a Table" name="booking" onclick="myFunction()" class="btn">
      ...
      <section class="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <a href="#">Home</a>
                <a href="./sales/sales.php">Sales Invoices</a>
                <a href="#booking">Table Reservation</a>
                <a href="./takeaway/takeaway.php">Takeaway</a>
                <a href="./delivery/delivery.php">Delivery</a>
                <a href="./tables/tables.php">Tables</a>
            </div>
    
            <div class="box">
                <h3 class="heading"> <span>Contact us</span> </h3>
                <p> <i class="fas fa-map-marker-alt"></i> Ghazieh, Main road, Chhoury bldg </p>
                <p> <i class="fas fa-envelope"></i>ahmad.shhouri.me@gmail.com</p>
                <p> <i class="fas fa-phone"></i> 71814942 // 07221847</p>
            </div>
    
        </div>
    
    <h1 class="credit"> created by <span>Techno Plus</span> | all rights reserved! </h1>
